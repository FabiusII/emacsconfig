...
(let ((class '((class color) (min-colors 89)))
  ...
  (custom-theme-set-faces
   ...
   `(rainbow-delimiters-depth-1-face ((,class :foreground "#D4C63C")))
   `(rainbow-delimiters-depth-2-face ((,class :foreground "#C16BC0")))
   `(rainbow-delimiters-depth-3-face ((,class :foreground "#7CB5DE")))
   `(rainbow-delimiters-depth-4-face ((,class :foreground "#D4C63C")))
   `(rainbow-delimiters-depth-5-face ((,class :foreground "#C16BC0")))
   `(rainbow-delimiters-depth-6-face ((,class :foreground "#7CB5DE")))
   `(rainbow-delimiters-depth-7-face ((,class :foreground "#D4C63C")))
   `(rainbow-delimiters-depth-8-face ((,class :foreground "#C16BC0")))
   `(rainbow-delimiters-depth-9-face ((,class :foreground "#7CB5DE")))
...
;;; vscode-default-dark-theme.el ends here
